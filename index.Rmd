...
Make sure you have the newest versions of R and R Studio. R should be 4.0.2 "Taking Off Again" (in case you are wondering, the interesting version names come from [Peanut cartoons](https://livefreeordichotomize.com/2018/04/23/r-release-names/)) and R Studio should be 1.3.1056.
