...
# this dataset is from a googlesheet
...
External data can be loaded in various ways depending its format and where it is. Data stored in Googlesheets are easy to load with the `googlesheets4` package. See an example of that in the dataset code chunk above.
